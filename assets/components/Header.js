    ...
    <div class="mx-auto relative max-w-7xl px-6 py-4 flex flex-col gap-4 md:flex-row md:items-center md:justify-between md:gap-6">
      ...
      <div class="flex items-center justify-between gap-4 md:flex-none">
        <a href="${basePath}index.html" class="flex items-center gap-3">
          ...
          <div>
            ...
            <h1 class="text-base font-black leading-tight text-white">${container.getAttribute('data-title') || 'System'}</h1>
          </div>
        </a>
      ...
      <div id="primary-nav" class="hidden flex-col gap-3 rounded-2xl border border-slate-800 bg-slate-900/90 p-4 text-sm font-semibold text-slate-200 shadow-lg shadow-blue-900/20 md:mt-0 md:flex md:flex-1 md:flex-row md:items-center md:justify-between md:border-0 md:bg-transparent md:p-0 md:shadow-none">
        ...
        <nav class="flex flex-col gap-2 md:flex-row md:items-center md:gap-1">
          ...
          <a id="nav-inventory-control" href="${basePath}pages/inventory-control.html" class="rounded-full px-3 py-1 transition-colors hover:text-white hover:bg-slate-800">Inventory</a>
          <a id="nav-services" href="${basePath}pages/admin/services.html" class="rounded-full px-3 py-1 transition-colors hover:text-white hover:bg-slate-800">Services</a>
          <a id="nav-dashboard" href="${basePath}pages/admin/index.html" data-dashboard-link aria-hidden="true" tabindex="-1" class="hidden rounded-full px-3 py-1 transition-colors hover:text-white hover:bg-slate-800 md:inline-flex">Dashboard</a>
          <a id="nav-contact" href="${basePath}pages/contact.html" class="rounded-full px-3 py-1 transition-colors hover:text-white hover:bg-slate-800">Contact</a>
        </nav>
        ...
        <div class="flex flex-col gap-3 border-t border-slate-800 pt-3 md:flex-row md:items-center md:gap-3 md:border-0 md:pt-0 md:flex-none md:justify-end" data-admin-actions>
          <a id="nav-login" href="${basePath}pages/login.html" class="rounded-full border border-blue-500 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-blue-100 transition hover:bg-blue-600 hover:text-white">Login</a>
